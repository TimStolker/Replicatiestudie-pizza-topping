...
pizzaKind = 'Hawaii' #Define the pizza type, this can be 'Hawaii' or 'Salame'
filename = 'PizzaHawaii.jpg'  #The filename of the pizza
...
def pizzaPixelCount(image):  #Counts the amount of pizza pixel in the image
    pizzaCounter = 0
...
def printToppingQuarters(type, splits):  #Type is either 'Hawaii' or 'Salame'
    pizzaPixels = pizzaPixelCount(image)
    quarterPizzaPixels = pizzaPixels/4  #amount of pixels in a quarter pizza

    #Every pizza has a base so the type doesn't matter
